...
class UserProfile {
  ...
  factory UserProfile.fromMap(Map<String, dynamic> map) {
    return UserProfile(
      ...
      tasks: map['tasks'] != null ? List<Task>.from((map['tasks'] as List<int>).map<Task?>((x) => Task.fromMap(x as Map<String,dynamic>),),) : null,
      notes: map['notes'] != null ? List<Note>.from((map['notes'] as List<int>).map<Note?>((x) => Note.fromMap(x as Map<String,dynamic>),),) : null,
    );
  }
